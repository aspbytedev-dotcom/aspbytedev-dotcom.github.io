(() => {
  const translations = {
      ...
      backgroundNote: "Kun Salamavahti on käytössä, palvelin lähettää ilmoituksen suoraan valitun alueen uudesta salamasta. Androidin noin 15 minuutin tarkistus toimii varajärjestelmänä.",
      dataKicker: "Avoimet ja tunnetut tietolähteet", dataTitle: "Salamahavainnot Ilmatieteen laitokselta",
      dataText: "AspByten Google Cloud -palvelu hakee FMI Open Datan yhteisen salamahavaintosyötteen ja jakaa sen sovelluksille. Kartta käyttää ensisijaisesti Google Mapsia; vararatkaisuna voidaan käyttää Leafletiä ja OpenStreetMapia.",
      ...
      privacyPointTwo: "GPS on vapaaehtoinen. Sovellus ei seuraa liikkeitäsi jatkuvasti eikä palvelin muodosta sijaintihistoriaa. Rekisteröinti poistetaan, kun Salamavahti pysäytetään.",
      ...
      policyPageTitle: "Salamatutkan tietosuojakäytäntö – AspByte", policyTitle: "Salamatutkan tietosuojakäytäntö", policyUpdated: "Voimassa 13.7.2026 alkaen · Viimeksi päivitetty 27.7.2026", backHome: "← Takaisin Salamatutkan etusivulle"
    },
    sv: {
      ...
      backgroundNote: "När Blixtvakten är aktiv skickar servern en direkt avisering om nya blixtar i det valda området. Androids kontroll ungefär var 15:e minut fungerar som reserv.",
      dataKicker: "Öppna och välkända datakällor", dataTitle: "Blixtobservationer från Meteorologiska institutet",
      dataText: "AspBytes Google Cloud-tjänst hämtar det gemensamma blixtflödet från FMI Open Data och distribuerar det till apparna. Kartan använder främst Google Maps; Leaflet och OpenStreetMap kan användas som reserv.",
      ...
      privacyPointOne: "Den valda punkten och radien sparas på enheten. När Blixtvakten är aktiv lagras exakta koordinater, radie och aviseringsidentifierare säkert på servern.", privacyPointTwo: "GPS är valfritt. Appen följer inte dina rörelser kontinuerligt och servern skapar ingen platshistorik. Registreringen raderas när Blixtvakten stoppas.",
      ...
      policyPageTitle: "Blixtradars integritetspolicy – AspByte", policyTitle: "Blixtradars integritetspolicy", policyUpdated: "Gäller från 13.7.2026 · Senast uppdaterad 27.7.2026", backHome: "← Tillbaka till Blixtradars startsida"
    },
    en: {
      ...
      backgroundNote: "When Lightning Watch is active, the server sends a direct alert for new lightning in the selected area. Android’s approximately 15-minute check acts as a fallback.",
      dataKicker: "Open and established data sources", dataTitle: "Lightning observations from the Finnish Meteorological Institute",
      dataText: "AspByte's Google Cloud service retrieves the shared lightning feed from FMI Open Data and distributes it to apps. The map primarily uses Google Maps; Leaflet and OpenStreetMap may be used as a fallback.",
      ...
      privacyPointOne: "The selected point and radius are stored on the device. While Lightning Watch is active, exact coordinates, radius and a notification delivery identifier are securely stored on the server.", privacyPointTwo: "GPS is optional. The app does not continuously track your movements, and the server does not build location history. Registration is deleted when Lightning Watch is stopped.",
      ...
      policyPageTitle: "Lightning Radar Privacy Policy – AspByte", policyTitle: "Lightning Radar Privacy Policy", policyUpdated: "Effective 13 July 2026 · Last updated 27 July 2026", backHome: "← Back to the Lightning Radar home page"
    }
  };
