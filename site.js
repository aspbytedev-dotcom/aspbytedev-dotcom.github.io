(() => {
  const translations = {
      ...
      backgroundNote: "Salamavahti vastaanottaa palvelinvaroituksia myös taustalla. Androidin noin 15 minuutin tarkistus toimii varajärjestelmänä; ilmoitusten toimitusaikaa ei voida taata.",
      dataKicker: "Avoimet ja tunnetut tietolähteet", dataTitle: "Salamahavainnot Ilmatieteen laitokselta",
      dataText: "Salamatutkan pilvipalvelu hakee Ilmatieteen laitoksen avoimen salamasyötteen kerran minuutissa ja jakaa viimeisten 15 minuutin havainnot sovelluksille. Suora FMI-haku toimii varajärjestelmänä, ja karttapohja on OpenStreetMapista.",
      ...
      privacyKicker: "Tietosuoja selkeästi", privacyTitle: "Ei käyttäjätiliä – tarkka hälytysalue säilyy puhelimessa",
      privacyPointOne: "Tarkka paikka, säde ja salamavahdin asetukset tallennetaan laitteellesi eikä niitä tallenneta Salamatutkan palvelimelle.",
      privacyPointTwo: "GPS on vapaaehtoinen eikä sovellus seuraa sijaintiasi taustalla.",
      privacyPointThree: "Salamavahdin ollessa käytössä Firebase käsittelee ilmoitusten toimittamiseksi likimääräistä karttaruutualuetta. Tarkka etäisyystarkistus tehdään puhelimessa.", readPrivacy: "Lue koko tietosuojakäytäntö →",
      ...
      policyPageTitle: "Salamatutkan tietosuojakäytäntö – AspByte", policyTitle: "Salamatutkan tietosuojakäytäntö", policyUpdated: "Voimassa 13.7.2026 alkaen · Viimeksi päivitetty 17.7.2026", backHome: "← Takaisin Salamatutkan etusivulle"
    },
    sv: {
      ...
      backgroundNote: "Blixtvakten tar emot servervarningar även i bakgrunden. Androids kontroll ungefär var 15:e minut fungerar som reserv; leveranstiden för aviseringar kan inte garanteras.",
      dataKicker: "Öppna och välkända datakällor", dataTitle: "Blixtobservationer från Meteorologiska institutet",
      dataText: "Blixtradars molntjänst hämtar Meteorologiska institutets öppna blixtdata en gång per minut och delar observationerna från de senaste 15 minuterna med apparna. En direkt FMI-hämtning fungerar som reserv, och kartunderlaget kommer från OpenStreetMap.",
      ...
      privacyKicker: "Tydlig integritet", privacyTitle: "Inget användarkonto – det exakta varningsområdet stannar i telefonen",
      privacyPointOne: "Exakt plats, radie och blixtvaktens inställningar lagras på enheten och inte på Blixtradars server.", privacyPointTwo: "GPS är valfritt och appen följer inte din position i bakgrunden.",
      privacyPointThree: "När blixtvakten är aktiv behandlar Firebase ett ungefärligt rutnätsområde för att leverera aviseringar. Den exakta avståndskontrollen görs i telefonen.", readPrivacy: "Läs hela integritetspolicyn →",
      ...
      policyPageTitle: "Blixtradars integritetspolicy – AspByte", policyTitle: "Blixtradars integritetspolicy", policyUpdated: "Gäller från 13.7.2026 · Senast uppdaterad 17.7.2026", backHome: "← Tillbaka till Blixtradars startsida"
    },
    en: {
      ...
      backgroundNote: "Lightning Watch receives server alerts in the background. Android's approximately 15-minute check remains as a fallback; notification delivery time cannot be guaranteed.",
      dataKicker: "Open and established data sources", dataTitle: "Lightning observations from the Finnish Meteorological Institute",
      dataText: "The Lightning Radar cloud service retrieves the Finnish Meteorological Institute's open lightning feed once per minute and shares the latest 15 minutes with the apps. A direct FMI request remains as a fallback, and the map base comes from OpenStreetMap.",
      ...
      privacyKicker: "Privacy made clear", privacyTitle: "No user account – the exact alert area stays on your phone",
      privacyPointOne: "The exact place, radius, and Lightning Watch settings are stored on your device, not on the Lightning Radar server.", privacyPointTwo: "GPS is optional, and the app does not track your location in the background.",
      privacyPointThree: "When Lightning Watch is enabled, Firebase processes an approximate grid area to deliver alerts. The exact distance check is performed on the phone.", readPrivacy: "Read the full privacy policy →",
      ...
      policyPageTitle: "Lightning Radar Privacy Policy – AspByte", policyTitle: "Lightning Radar Privacy Policy", policyUpdated: "Effective 13 July 2026 · Last updated 17 July 2026", backHome: "← Back to the Lightning Radar home page"
    }
  };
