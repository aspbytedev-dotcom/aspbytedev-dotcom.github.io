(() => {
  ...
  const translations = {
      ...
      pageDescription: "Salamatutka näyttää tuoreet salamahavainnot, salamatiheyskartan ja ukkosalueen arvioidun liikesuunnan sekä lähettää hälytyksen valitsemallesi 3–20 km alueelle.",
      ...
      featuresLead: "Näet tuoreimmat salamahavainnot, niiden keskittymät ja ukkosalueen arvioidun liikesuunnan sekä sen, osuuko havainto valitsemallesi alueelle.",
      ...
      featureHeatTitle: "Salamatiheyskartta", featureHeatText: "Tiheyskartta näyttää yhdellä silmäyksellä alueet, joille viimeaikaiset salamahavainnot keskittyvät.",
      featureMotionTitle: "Arvioitu liikesuunta", featureMotionText: "Selkeä nuoli arvioi ukkosalueen liikesuuntaa viimeaikaisten havaintojen perusteella, kun havaintoja on riittävästi. Kyse ei ole sääennusteesta.",
    ...
    sv: {
      ...
      featuresLead: "Se de senaste blixtobservationerna, deras koncentrationer och åskområdets uppskattade rörelseriktning samt om en observation finns inom ditt valda område.",
      ...
      featureHeatTitle: "Täthetskarta för blixtar", featureHeatText: "Täthetskartan visar direkt var de senaste blixtobservationerna är koncentrerade.",
      featureMotionTitle: "Uppskattad rörelseriktning", featureMotionText: "En tydlig pil uppskattar åskområdets rörelseriktning utifrån de senaste observationerna när underlaget räcker. Detta är ingen väderprognos.",
    ...
    en: {
      ...
      featuresLead: "See the latest lightning observations, their concentrations and the storm area's estimated movement direction, plus whether an observation falls inside your selected area.",
      ...
      featureHeatTitle: "Lightning density heatmap", featureHeatText: "The heatmap shows at a glance where recent lightning observations are concentrated.",
      featureMotionTitle: "Estimated movement direction", featureMotionText: "A clear arrow estimates the storm area's movement from recent observations when enough data is available. It is not a weather forecast.",
